01 Array - Basics of Array
===
# 1. Info
> An array is a collection of similar data elements stored at contiguous memory locations. It is the simplest data structure **where each data element can be accessed directly by only using its index number.**

![截圖 2023-11-26 下午10.56.55](https://hackmd.io/_uploads/BJHanAgBT.png)
### Array consists of:
> * starting address
> * dimension
...
![image](https://hackmd.io/_uploads/B1DnPyWBp.png)  
Above is a two-dimensional array. Most of the cases are in 2-D, ==we could also see them as **matrices**==, and apply functions on them, e,g, matrix addition, multiplication, division and subtraction.
...
> #### Time complexity : O(1)
![image](https://hackmd.io/_uploads/SyzFBXfB6.png)
...
> #### Time complexity: O(N).
![image](https://hackmd.io/_uploads/H1W5r7zBa.png)
...
> #### Time complexity: O(1).  
![image](https://hackmd.io/_uploads/Sk8sBQMHT.png)
...
> #### Time complexity: O(1).
![image](https://hackmd.io/_uploads/ByuEPXGBa.png)

### 2.5.2 delete element $i$
1. check if $i$ is valid
2. pop $i$th val, and move the i+1 elements to the left
3. len(Arr) = len(Arr)-1
> #### Time complexity: O(N).  
![image](https://hackmd.io/_uploads/BJPfOXzBp.png)
